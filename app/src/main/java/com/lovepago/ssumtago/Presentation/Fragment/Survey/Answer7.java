...
public class Answer7 extends Fragment implements AnswerInterface{
    @BindViews({R.id.btn_answer7_1,R.id.btn_answer7_2,R.id.btn_answer7_3,R.id.btn_answer7_4,R.id.btn_answer7_5,R.id.btn_answer7_6,R.id.btn_answer7_7})
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_answer7,container,false);
