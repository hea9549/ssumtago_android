...
public class Answer8 extends Fragment implements AnswerInterface{
    @BindViews({R.id.btn_answer8_1,R.id.btn_answer8_2,R.id.btn_answer8_3,R.id.btn_answer8_4,R.id.btn_answer8_5,R.id.btn_answer8_6,R.id.btn_answer8_7,R.id.btn_answer8_8})
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_answer8,container,false);
