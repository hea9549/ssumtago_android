...
public class Answer4 extends Fragment implements AnswerInterface{
    @BindViews({R.id.btn_answer4_1,R.id.btn_answer4_2,R.id.btn_answer4_3,R.id.btn_answer4_4})
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_answer4,container,false);
