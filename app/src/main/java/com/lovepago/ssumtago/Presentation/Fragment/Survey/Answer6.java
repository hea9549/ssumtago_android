...
public class Answer6 extends Fragment implements AnswerInterface{
    @BindViews({R.id.btn_answer6_1,R.id.btn_answer6_2,R.id.btn_answer6_3,R.id.btn_answer6_4,R.id.btn_answer6_5,R.id.btn_answer6_6})
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_answer6,container,false);
