...
public class Answer5 extends Fragment implements AnswerInterface{
    @BindViews({R.id.btn_answer5_1,R.id.btn_answer5_2,R.id.btn_answer5_3,R.id.btn_answer5_4,R.id.btn_answer5_5})
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_answer5,container,false);
