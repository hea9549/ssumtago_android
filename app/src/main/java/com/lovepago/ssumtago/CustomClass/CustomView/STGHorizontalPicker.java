...
/**
 * Created by ParkHaeSung on 2017-07-17.
 */


public class STGHorizontalPicker extends View {
    /*
 ...
 */
     ...
     */
        ...
        public STGHorizontalPicker(Context context) {
            this(context, null);
        }

        public STGHorizontalPicker(Context context, AttributeSet attrs) {
            this(context, attrs, R.attr.STGhorizontalPickerStyle);
        }

        public STGHorizontalPicker(Context context, AttributeSet attrs, int defStyle) {
            ...
            TypedArray a = context.getTheme().obtainStyledAttributes(
                    attrs,
                    R.styleable.STGHorizontalPicker,
                    defStyle, 0
            );
            ...
            try {
                textColor = a.getColorStateList(R.styleable.STGHorizontalPicker_android_textColor);
                if (textColor == null) {
                    textColor = ColorStateList.valueOf(0xFF000000);
                }

                values = a.getTextArray(R.styleable.STGHorizontalPicker_values);
                ellipsize = a.getInt(R.styleable.STGHorizontalPicker_android_ellipsize, ellipsize);
                marqueeRepeatLimit = a.getInt(R.styleable.STGHorizontalPicker_android_marqueeRepeatLimit, marqueeRepeatLimit);
                dividerSize = a.getDimension(R.styleable.STGHorizontalPicker_dividerSize, dividerSize);
                sideItems = a.getInt(R.styleable.STGHorizontalPicker_sideItems, sideItems);

                float textSize = a.getDimension(R.styleable.STGHorizontalPicker_android_textSize, -1);
                if(textSize > -1) {
...
//            postInvalidateOnAnimation(); // TODO
        ...
        private int getColor(int scrollX, int position) {
            ...
            if(pressedItem == position) {
                ...
                selectedColor =  Color.rgb(255,255,255);
            } else {
        ...
        private static final class Marquee extends Handler {
            ...
            private final WeakReference<STGHorizontalPicker> mView;
            ...
            Marquee(STGHorizontalPicker v, Layout l, boolean rtl) {
                ...
                mView = new WeakReference<STGHorizontalPicker>(v);
            ...
            void tick() {
                ...
                final STGHorizontalPicker view = mView.get();
        ...
        public static class SavedState extends BaseSavedState {
            ...
            public String toString() {
                return  "STGHorizontalPicker.SavedState{"
        ...
        private static class PickerTouchHelper extends ExploreByTouchHelper {
            ...
            private STGHorizontalPicker mPicker;

            public PickerTouchHelper(STGHorizontalPicker picker) {
                super(picker);
                mPicker = picker;
            }
