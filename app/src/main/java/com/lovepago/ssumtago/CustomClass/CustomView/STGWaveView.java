...
public class STGWaveView extends View {
        /**
         * +------------------------+
         * |<--wave length->        |______
         * |   /\          |   /\   |  |
        ...
        public STGWaveView(Context context) {
            super(context);
            init();
        }

        public STGWaveView(Context context, AttributeSet attrs) {
            super(context, attrs);
            init();
        }

        public STGWaveView(Context context, AttributeSet attrs, int defStyle) {
